...
PRAYER_DUAS = {
    "fajr":    "قال ﷺ: «ركعتا الفجر خير من الدنيا وما فيها» [مسلم]",
    "dhuhr":   "قال ﷺ: «من حافظ على أربع ركعات قبل الظهر وأربع بعدها حرّمه الله على النار» [أبو داود]",
    "asr":     "قال تعالى: ﴿حَافِظُوا عَلَى الصَّلَوَاتِ وَالصَّلَاةِ الْوُسْطَىٰ﴾\nوالوسطى هي العصر — فلا تفوّتها 🌤️",
    "maghrib": "قال ﷺ: «لا تزال أمتي بخير ما لم يؤخّروا المغرب إلى أن تشتبك النجوم» [أبو داود]",
...
def prayer_reminder_text(prayer_key: str, prayer_time: datetime.time, hijri: str) -> str:
    ...
    dua  = PRAYER_DUAS[prayer_key]
    return (
        f"🕌 *{name}*\n"
        f"📅 {hijri}\n"
        f"⏰ الوقت: *{prayer_time.strftime('%H:%M')}* (بتوقيت الجزائر)\n\n"
        f"{dua}\n\n"
        "━━━━━━━━━━━━━━━━━━━━━\n"
